...
export default function TrashTraceAuth() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden" style={{
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-black/50 via-black/40 to-emerald-900/30"></div>
      ...
      {/* Decorative floating recycle icons */}
      ...
      <div className="absolute bottom-20 left-20 opacity-10 pointer-events-none animate-pulse" style={{animationDelay: '1s'}}>
              ...
              {!isSignUp && (
                <>
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-6">
                    <button className="py-3 px-4 backdrop-blur-sm bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl text-white font-medium transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2">
                      <Trash2 size={18} />
                      Worker
                    </button>
                    <button className="py-3 px-4 backdrop-blur-sm bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl text-white font-medium transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2">
